...
import { EvaluationCriteriaRequest, EvaluationCriteriaResponse } from '../models/evaluation-criteria.model';
...
export class EvaluationCriteriaService {
   ...
   */
  getCriterion(criterionId: number): Observable<EvaluationCriteriaResponse> {
  ...
  ): Observable<EvaluationCriteriaResponse> {
    // Uncomment the line below when the backend is ready
